...
const Wallet = () => {
    ...
    return (
      <TouchableOpacity style={styles.headerContainer}>
        <View style={styles.headerLeft}>
          ...
          />
          <Text style={[styles.headerTitle, { color: dark ? COLORS.white : COLORS.greyscale900 }]}>My Wallet</Text>
        </View>
        <TouchableOpacity>
          <Image
    ...
    return (
      <View style={styles.cardContainer}>
        ...
        <View style={styles.bottomCardContainer}>
          <Text style={styles.amountNumber}>$952.67</Text>
          <TouchableOpacity
  ...
  const renderTransactionHistory = () => {
    return (
      <View>
        <SectionHeader title="Transaction History" subtitle="See All" onPress={() => navigation.navigate("transactionhistory")} />
        <FlatList
