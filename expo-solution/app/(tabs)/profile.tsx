      ...
      <TouchableOpacity style={styles.headerContainer}>
        <View style={styles.headerLeft}>
          <Image
            ...
            style={styles.logo}
          />
          <Text style={[styles.headerTitle, { color: dark ? COLORS.white : COLORS.greyscale900 }]}>Profile</Text>
        </View>
        <TouchableOpacity>
          <Image
  ...
  const renderProfile = () => {
    ...
    return (
      <View style={styles.profileContainer}>
        ...
        <Text style={[styles.title, { color: dark ? COLORS.white : COLORS.greyscale900 }]}>Nathalie Erneson</Text>
        <Text style={[styles.subtitle, { color: dark ? COLORS.white : COLORS.greyscale900 }]}>nathalie_erneson@gmail.com</Text>
      </View>
    )
  };
        ...
        <TouchableOpacity
          ...
          <View style={styles.leftContainer}>
            <Image
              source={icons.more}
              resizeMode='contain'
              style={[styles.settingsIcon, { tintColor: dark ? COLORS.white : COLORS.greyscale900 }]}
            />
            <Text style={[styles.settingsName, { color: dark ? COLORS.white : COLORS.greyscale900}]}>Language & Region</Text>
          </View>
          <View style={styles.rightContainer}>
            <Text style={[styles.rightLanguage, { color: dark ? COLORS.white : COLORS.greyscale900 }]}>English (US)</Text>
            <Image
              source={icons.arrowRight}
              resizeMode='contain'
              style={[styles.settingsArrowRight, { tintColor: dark ? COLORS.white : COLORS.greyscale900 }]}
            />
          </View>
        </TouchableOpacity>
        <TouchableOpacity
  ...
  return (
    <SafeAreaView style={[styles.area, { backgroundColor: colors.background }]}>
      ...
      <RBSheet
        ...
        <Text style={[styles.bottomSubtitle, { color: dark ? COLORS.white : COLORS.black }]}>Are you sure you want to logout?</Text>
