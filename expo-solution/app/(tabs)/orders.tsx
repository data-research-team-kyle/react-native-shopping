...
const Orders = () => {
  ...
  const renderTabBar = (props: any) => (
    <TabBar
      {...props}
      indicatorStyle={{ backgroundColor: dark ? COLORS.white : COLORS.primary }}
    ...
    return (
      <View style={styles.headerContainer}>
        <View style={styles.headerLeft}>
          ...
          <Text style={[styles.headerTitle, { color: dark ? COLORS.white : COLORS.greyscale900 }]}>My Orders</Text>
        </View>
        <TouchableOpacity>
          <Image
