...
const Category: React.FC<CategoryProps> = ({ name, icon, onPress }) => {
  ...
  return (
    <View style={styles.container}>
      <TouchableOpacity
        onPress={onPress}
        style={[styles.iconContainer, { backgroundColor: dark ? COLORS.dark3 : COLORS.silver}]}>
        <Image source={icon} resizeMode='contain' style={[styles.icon, { tintColor: dark ? COLORS.white : COLORS.greyscale900 }]} />
      </TouchableOpacity>
